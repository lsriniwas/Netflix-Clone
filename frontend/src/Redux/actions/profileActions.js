const { GET_PROFILES_REQ, GET_PROFILES_SUCCESS, GET_PROFILES_FAIL, ADD_PROFILE_REQ, ADD_PROFILE_SUCCESS, ADD_PROFILE_FAIL, CURRENT_PROFILE } = require("../actionTypes/profileActionTypes")
