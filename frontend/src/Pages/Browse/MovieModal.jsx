...
export const MovieModal = ({ modalClose, Movie }) => {
    ...
    React.useEffect(() => {
        // var config = {
        //     method: 'get',
        //     url: 'http://localhost:8000/api/tvshow/watch/601a47ddba1dcf376e6b89ab',
        //     headers: { },
        //     data : "601a47ddba1dcf376e6b89ab"
        //   };

        //   axios(config)
        //   .then(res=>{
        //     setMovie(res.data)
        //     setEpisodeList(res.data.seasons[index].episodes)
        // })
            ...
            <div className={styles.reactplayer}>
                 ...
                 */}
                  <iframe style={{
                      marginTop:'-70px',
                    //   marginBottom:'-70px'
                  }}  width="100%" title="hello" height="576" src={`https://www.youtube.com/embed/${movie.video}?autoplay=1&showinfo=0&controls=0&mute=1&rel=0`} frameborder="0" autoplay="1"
